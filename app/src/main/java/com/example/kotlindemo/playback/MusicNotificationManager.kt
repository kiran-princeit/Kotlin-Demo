...
class MusicNotificationManager internal constructor(private val mMusicService: MusicService) {
    ...
    fun createNotification(): Notification {
        ...
        val openPlayerIntent = Intent(mMusicService, PlaybackActivity::class.java)
        ...
        notificationBuilder!!
            .setShowWhen(false)
            .setSmallIcon(R.drawable.iv_music_album)
            .setLargeIcon(Utils.songArt(song.albumArtUri.toString()!!,mMusicService.baseContext))
            .setColor(ContextCompat.getColor(context, R.color.black1))
    ...
    private fun initMediaSession(song: AudioFile) {
    ...
    private fun updateMetaData(song: AudioFile) {
        mediaSession!!.setMetadata(MediaMetadataCompat.Builder()
            .putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART, Utils.songArt(song.albumArtUri.toString()!!, context))
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, song.artist)
            .putString(MediaMetadataCompat.METADATA_KEY_ALBUM, song.uri.toString())
